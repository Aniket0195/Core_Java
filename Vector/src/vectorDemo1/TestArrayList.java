...
public class TestArrayList {
	...
	public static void main(String[] args) {
		...
		This line of code declares and initializes a new ArrayList object named "lst" which will be used to store integer values. The "Integer" type argument inside angle brackets specifies that the ArrayList will only hold objects of the Integer wrapper class, i.e., integer values.*/
...
//		}
		...
		//Predicate p=(x)->(int)x==num;//Generally predicate means a statement that determines whether a value could be true or false.
		//lst.removeIf(p);
